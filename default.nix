...
in
# Prepend all packages for current system so that various update
# scripts and nixpkgs-hammering can find the packages without having
# to recurse into outputs.
