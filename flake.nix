{
  inputs = {
    ...
    home-manager-stable = { url = "github:nix-community/home-manager/release-24.11"; inputs.nixpkgs.follows = "nixpkgs-stable"; };
            ...
            inputs.nix-index-database.nixosModules.nix-index
            {
              ...
              nixpkgs.overlays = (common-overlays "x86_64-linux") ++ [
                ...
                (final: prev: {
                  ...
                  inherit (nixpkgs.outputs.legacyPackages.x86_64-linux) sequoia-sq yazi live-server swayr;
                })
              ];
            }
          ];
